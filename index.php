    ...
    <body>
        ...
        <section id="car-block">
            <div class="car-right animation-block">
                <img src="assets/images/_car-big-side.png" alt="Car"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h4 class="yellow"></h4>
        ...
        <section id="tariffs" class="parallax" style="background-image: url(assets/images/_tariff-bg.jpg);">
            <div class="container">
                <h4 class="yellow">See Our</h4>
                <h2 class="h1">Vehicles</h2>
                <div class="row">
                    ...
                    <div class="swiper-wrapper">
                        <div class="col-md-4 col-sm-6 swiper-slide">
                            <div class="inner matchHeight">
                                <div class="text">
                                    <p>Nullam orci dui, dictum et magna sollicitudin,  a id lacus. Fusce tincidunt in leo lacinia condimentum.</p>
                                </div>
                                <div class="quote">
